...
struct BitwiseAndOp { int operator()(int x, int y) { return x & y; }};
struct BitwiseOrOp { int operator()(int x, int y) { return x | y; }};
struct BitwiseXorOp { int operator()(int x, int y) { return x ^ y; }};
struct MaxOp { int operator()(int x, int y) { return x > y ? x : y; }};
struct MinOp { int operator()(int x, int y) { return x < y ? x : y; }};
...
struct Env
{
    ...
    Env() : outer(NULL) {}
    Env(Env* outer_env) : outer(outer_env) {}
